...
export const erc20ABI = [
  ...
  // Sample DEX (Decentralized Exchange) ABI (simplified)
  export const dexABI = [
    {
      "inputs": [
  ...
  // Sample Vault contract ABI for automatic investment
  ...
  // Sample ABIs by contract address for demo purposes
  export const contractABIs: Record<string, any> = {
    // Demo contract addresses
    "0x1234567890123456789012345678901234567890": erc20ABI,
    "0x0987654321098765432109876543210987654321": dexABI,
    "0xabcdef1234567890abcdef1234567890abcdef12": vaultABI
  }; 